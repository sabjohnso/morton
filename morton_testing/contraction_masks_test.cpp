  ...
  TEST_CASE("contraction") {
    ...
    SECTION("4bits/index") {
      ...
      SECTION("2-dimensional") {
        ...
        CHECK(0b00000000u == masks(0b00000000u));
        CHECK(0b00000001u == masks(0b00000001u));
      ...
      SECTION("3-dimensional") {
        ...
        CHECK(0b000000000000u == masks(0b000000000000u));
        CHECK(0b000000000001u == masks(0b000000000001u));
